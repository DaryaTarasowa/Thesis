...
%\bottomrule
%\end{tabular}
%\caption{Data quality metrics divided into four groups.}
%\label{tab:data_quality_groups}
%\end{table}
%
%We confine ourselves to the objective requirements discussed in~\cite{Zaveri} and divide them into four groups (cf.~\autoref{tab:data_quality_groups}) according to the stage of mapping creation, on which they can be influenced:
%
%\begin{itemize}
...
%
%\end{tabulary}
%\caption{Results of survey on degree of agreement with the key concepts of the proposed methodology.}
%\label{tab:survey}
%\end{table*}
%
...
%The survey results are presented in~\autoref{tab:survey}.
%Numbers in the table represent the degree of agreement from \emph{absolutely agree} (5) to \emph{absolutely disagree} (1). The colors indicate the self-estimated level of expertise in the RDB2RDF domain from \emph{expert} (darkest) to \emph{experienced} (lightest).
%
...
%
%As~\autoref{tab:survey} shows, the experts approved most of the requirements. 
...
%------------------------------------------------------------------------------
\chapter{Extractions from R2RML mapping representation}
\label{app1:r2rml}
%------------------------------------------------------------------------------
...
\chapter{SlideWiki knowledge graph}
